...
retvalue logger_init(const char *confdir,const char *logdir,const char *codename,const char *option,/*@null@*/const struct strlist *notificators,/*@out@*/struct logger **);

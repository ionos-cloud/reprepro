...
-e1*=db: 'pool/everything/p/package/package-addons_9-2_all.deb' added to files.db(md5sums).
-d1*=db: 'pool/everything/p/package/package-addons_9-2_all.deb' added to checksums.db(pool).
-e1*=db: 'pool/everything/p/package/package_9-2_${FAKEARCHITECTURE}.deb' added to files.db(md5sums).
-d1*=db: 'pool/everything/p/package/package_9-2_${FAKEARCHITECTURE}.deb' added to checksums.db(pool).
-e1*=db: 'pool/everything/p/package/package_9-2.tar.gz' added to files.db(md5sums).
-d1*=db: 'pool/everything/p/package/package_9-2.tar.gz' added to checksums.db(pool).
-e1*=db: 'pool/everything/p/package/package_9-2.dsc' added to files.db(md5sums).

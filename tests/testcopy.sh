...
-e1*=db: 'pool/one/a/aa/aa-addons_4-2_all.deb' added to files.db(md5sums).
-d1*=db: 'pool/one/a/aa/aa-addons_4-2_all.deb' added to checksums.db(pool).
-e1*=db: 'pool/one/a/aa/aa_1-1_${FAKEARCHITECTURE}.deb' added to files.db(md5sums).
-d1*=db: 'pool/one/a/aa/aa_1-1_${FAKEARCHITECTURE}.deb' added to checksums.db(pool).
-e1*=db: 'pool/one/a/aa/aa_1-1.tar.gz' added to files.db(md5sums).
-d1*=db: 'pool/one/a/aa/aa_1-1.tar.gz' added to checksums.db(pool).
-e1*=db: 'pool/one/a/aa/aa_1-1.dsc' added to files.db(md5sums).
...
-e1*=db: 'pool/two/a/aa/aa-addons_3-2_all.deb' added to files.db(md5sums).
-d1*=db: 'pool/two/a/aa/aa-addons_3-2_all.deb' added to checksums.db(pool).
-e1*=db: 'pool/two/a/aa/aa_1-2_${FAKEARCHITECTURE}.deb' added to files.db(md5sums).
-d1*=db: 'pool/two/a/aa/aa_1-2_${FAKEARCHITECTURE}.deb' added to checksums.db(pool).
-e1*=db: 'pool/two/a/aa/aa_1-2.tar.gz' added to files.db(md5sums).
-d1*=db: 'pool/two/a/aa/aa_1-2.tar.gz' added to checksums.db(pool).
-e1*=db: 'pool/two/a/aa/aa_1-2.dsc' added to files.db(md5sums).

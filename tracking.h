...
retvalue trackingdata_insert(struct trackingdata *, enum filetype, const struct strlist * /*filekeys*/, /*@null@*//*@only@*/char * /*oldsource*/, /*@null@*//*@only@*/char * /*oldversion*/, /*@null@*/const struct strlist * /*oldfilekeys*/);

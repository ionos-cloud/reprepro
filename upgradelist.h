...
retvalue upgradelist_initialize(struct upgradelist **, /*@dependent@*/struct target *, struct database *);
...
retvalue upgradelist_listmissing(struct upgradelist *, struct database *);
...
retvalue upgradelist_install(struct upgradelist *, /*@null@*/struct logger *, struct database *, bool /*ignoredelete*/, void (*)(void *, const char **, const char **));
